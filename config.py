...
DEFAULT_ROLE_PERMISSIONS = {
    ...
    "Boss": ["CONTRACT", "MODEL_DICTIONARY", "SALES_CREATE", "DEALER_ORDER_REVIEW", "SALES_ALLOC", "SHIP_CONFIRM", "ARCHIVE", "MACHINE_EDIT", "WAREHOUSE_MAP", "LOG_VIEW", "QUERY", "INBOUND", "TRACEABILITY", "KANBAN_VIEW", "SANDBOX_VIEW", "SANDBOX_EDIT"],
