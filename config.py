...
DEFAULT_ROLE_PERMISSIONS = {
    "Admin": ["CONTRACT", "MODEL_DICTIONARY", "USER_MANAGE", "SALES_CREATE", "DEALER_ORDER_REVIEW", "SALES_ALLOC", "SHIP_CONFIRM", "ARCHIVE", "MACHINE_EDIT", "WAREHOUSE_MAP", "LOG_VIEW", "QUERY", "INBOUND", "TRACEABILITY", "KANBAN_VIEW", "SANDBOX_VIEW", "SANDBOX_EDIT"],
    "Boss": ["CONTRACT", "MODEL_DICTIONARY", "SALES_CREATE", "DEALER_ORDER_REVIEW", "SALES_ALLOC", "SHIP_CONFIRM", "ARCHIVE", "MACHINE_EDIT", "WAREHOUSE_MAP", "LOG_VIEW", "QUERY", "INBOUND", "TRACEABILITY", "KANBAN_VIEW", "SANDBOX_VIEW", "SANDBOX_EDIT", "NOTIFICATION_VIEW"],
    "Sales": ["CONTRACT", "SALES_CREATE", "DEALER_ORDER_REVIEW", "SALES_ALLOC", "WAREHOUSE_MAP", "LOG_VIEW", "QUERY", "TRACEABILITY"],
    "Prod": ["SHIP_CONFIRM", "ARCHIVE", "MACHINE_EDIT", "WAREHOUSE_MAP", "LOG_VIEW", "QUERY", "INBOUND"],
    "Inbound": ["WAREHOUSE_MAP", "INBOUND"],
    "AfterSales": ["QUERY"],
    "LineOperator": ["MOBILE_KANBAN_VIEW", "MOBILE_KANBAN_ASSIGN"],
}
