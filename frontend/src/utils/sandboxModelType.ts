export function normalizeModelType(raw: string): string {
  ...
  if (upper === 'SPECIAL' || upper === 'FT' || upper.startsWith('FR-1080') || upper.startsWith('FH-') || upper.startsWith('FL-') || upper.startsWith('FR-8080') || upper.startsWith('FR-1100')) return 'SPECIAL'
